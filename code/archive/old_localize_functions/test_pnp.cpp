...
static void test_pnp()
{
  ...
  float f = pixart::cam_params::focal_length_x_pixels();
  float w = pixart::cam_params::pixels_x;
  float h = pixart::cam_params::pixels_y;
  ...
  float fx = pixart::cam_params::focal_length_x_pixels();
  float fy = pixart::cam_params::focal_length_y_pixels();
  float cx = 0;
  float cy = 0;
  float intrinsic[3][3] =
  {
