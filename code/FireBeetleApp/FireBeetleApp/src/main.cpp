...
* Connections to Firebeetle 2 ESP-WROOM-32E board headers:

  VDDMA          -> 3v3   (recommend pin nearest GND)
  G6/FOD_TRIGGER -> UNUSED
  G8/VSYNCH      -> UNUSED
  G9/CSB         -> FBEETLE GPIO 4
  G10/SCK        -> FBEETLE GPIO 18
  G11/MISO       -> FBEETLE GPIO 19
  G12/MOSI       -> FBEETLE GPIO 23
  GND            -> FBEETLE GND
